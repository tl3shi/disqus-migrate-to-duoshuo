...
def main():
    usage = "usage:python %prog [options] file"
    parser = OptionParser(usage)
    parser.add_option("-s", "--title-suffix", dest="titleSuffix", help="Thread suffix")
    parser.add_option("-u", "--site-url", dest="siteURL", help="web site url")
